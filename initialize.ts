...
function setup(): void {
    ...
    EngineAssets.getInstance().load( [
        ...
        [ "tree-b", "assets/models/tree-b.glb" ],
...
function register(): void {
    ...
    Asteroids.getInstance().register( "ring", { key: 0, seed: "7417", radius: 5 * 1000, spread: 400, height: 80, density: 0.0/*6*/ } );
    Asteroids.getInstance().register( "ring", { key: 1, seed: "4674", radius: 5 * 1000, spread: 1200, height: 40, density: 0.0/*4*/ } );
